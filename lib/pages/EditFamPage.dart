...
class EditFamPage extends StatefulWidget {
  ...
  @override
  _EditFamPageState createState() => _EditFamPageState();
}

class _EditFamPageState extends State<EditFamPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Edit Fam', style: TextStyle(color: Colors.white),),
          actions: <Widget>[
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            'Fam Name', style: TextStyle(color: Colors.grey),
          ),
        ),
        TextField(
          ...
          decoration: InputDecoration(
            ...
            errorText: _profileNameValid ? null : 'Fam name is very short',
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: "Express about your family ...",
            enabledBorder: UnderlineInputBorder(
              borderSide: BorderSide(color: Colors.grey),
            ),
            focusedBorder: UnderlineInputBorder(
