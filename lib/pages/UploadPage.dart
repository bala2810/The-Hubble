 ...
 TextEditingController locationTextEditingController=TextEditingController();
  ...
  takeImage(mContext){
    return showDialog(
        ...
        builder: (context){
          return SimpleDialog(
            title:Text('New post',style: TextStyle(color:Colors.white,fontWeight: FontWeight.bold,fontSize: 40),),
            children:<Widget>[
              SimpleDialogOption(
  ...
  displayUploadScreen(){
    return Container(
      ...
      child:Column(
        ...
        children: <Widget>[
          Icon(Icons.add_photo_alternate,color:Colors.blueGrey,size:100),
          Padding(
