  ...
  createPostHead(){
    return FutureBuilder(
      ...
      builder:(context,dataSnapshot){
        ...
        return ListTile(
          leading: CircleAvatar(backgroundImage:CachedNetworkImageProvider(user.url),backgroundColor: Colors.blueGrey,),
          ...
          subtitle: Text(location,style: TextStyle(color:Colors.white70),),
  ...
  createPostPicture(){
    return GestureDetector(
      ...
      child:Stack(
        ...
        children: <Widget>[
          Image.network(url),
          showHeart ? Icon(Icons.favorite, size: 120,color:Colors.redAccent):Text(''),
        ],
      )
    );
  }
